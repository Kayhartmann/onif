...
if bashio::config.exists 'cameras'; then
  ...
  ${CAM_NAME}: rtsp://127.0.0.1:${NEOLINK_PORT}/${CAM_NAME}/main#backchannel=0#timeout=30000
  ${CAM_NAME}_sub: rtsp://127.0.0.1:${NEOLINK_PORT}/${SUB_PATH}#backchannel=0#timeout=30000"
    done
fi
